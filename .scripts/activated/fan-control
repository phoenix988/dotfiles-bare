...
MAXTHRESHOLD=70    # Fans will run at 100% if hotter than this temperature
tempThresh[0]=60   # <-- Apply curve[0] if hotter than
tempThresh[1]=50   # <-- Apply curve[1] if hotter than
tempThresh[2]=40   # <-- Apply curve[2] if hotter than
tempThresh[3]=30   # <-- Apply curve[3] if hotter than
tempThresh[4]=20   # <-- Apply curve[4] if hotter than
